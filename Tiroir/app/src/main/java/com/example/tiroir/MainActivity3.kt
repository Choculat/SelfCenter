...
class MainActivity3 : AppCompatActivity() {
    ...
    private fun setupWebView() {
        ...
        webView.loadUrl("https://24628528.xyz/")
    }
    ...
    private fun setupDrawerItemSelected() {
        ...
        binding.nvTiroir.setNavigationItemSelectedListener { item ->
            when (item.itemId) {
                R.id.activite1_item -> {
                    Snackbar.make(binding.root, "Activité 1", Snackbar.LENGTH_SHORT).show()
                    startActivity(Intent(this, MainActivity::class.java))
                }
                R.id.activite2_item -> {
                    Snackbar.make(
                        binding.root, "Activité 2", Snackbar.LENGTH_SHORT
                    ).show()
                    startActivity(Intent(this, MainActivity2::class.java))
                }
                R.id.activite3_item -> {
                    Snackbar.make(
                        binding.root, "Activité 3", Snackbar.LENGTH_SHORT
                    ).show()
